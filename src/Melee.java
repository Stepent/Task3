public class Melee extends Unit {
    ...
    private double swamp_penalty = 1.5;
    private double hills_penalty = 2;
    private double tree_penalty = 1.2;

    public Melee(String name, int health, int strength, int range, int defence, int movement, int cost) {
        super(name, health, strength, range, defence, movement, cost);
    }

    @Override
    public String toString() {
        return "Тип: Ближний бой, название: " + getName() + ", здоровье: " + getHealth() + ", сила: " + getStrength() + ", дальность атаки: " + getRange() +
